...
!(function () {
    ...
    function n(e, t) {
        ...
        if (("." === o && ("/" === i || ("." === i && ("/" === e[2] || (2 === e.length && (e += "/")))) || (1 === e.length && (e += "/")))) || "/" === o) {
            ...
            if (
                (s
                    ? (void 0 === t && r(e, t), (a = t))
                    : (a = "/" === t[n.length + 1] ? ("file:" !== n ? (a = t.substr(n.length + 2)).substr(a.indexOf("/") + 1) : t.substr(8)) : t.substr(n.length + 1)),
                "/" === o)
            ) {
    ...
    function b(e, r, n, o, i, a) {
        var s;
        if ((a.push(r), n.setters))
            for (var u, c, d = 0; d < n.dependencies.length; d++)
                if (!((u = n.dependencyInstantiations[d]) instanceof l) && ((c = u.linkRecord) && -1 === a.indexOf(u) && (s = u.evalError ? u.evalError : b(e, u, c, o, i, c.setters ? a : [])), s))
        ...
        for (var n in t)
            if (Object.hasOwnProperty.call(t, n)) {
                ...
                void 0 === e[n]
                    ...
                    : "object" == typeof o && null !== o && "object" == typeof e[n]
                    ? (e[n] = (r ? E : k)(k({}, e[n]), o))
                    : r || (e[n] = o);
            }
    }
    ...
    function L(e, t, r) {
        ...
        r &&
            (t.pluginFirst ? -1 !== (n = r.lastIndexOf("!")) && (o.pluginArgument = o.pluginKey = r.substr(0, n)) : -1 !== (n = r.indexOf("!")) && (o.pluginArgument = o.pluginKey = r.substr(n + 1)),
            (o.packageKey = R(t.packages, r)),
    ...
    function W(e, t, r) {
        ...
        for (var o in e) {
            ...
            if (
                (i && (o = o.substr(2)),
                -1 !== (n = o.indexOf("*")) && o.substr(0, n) === t.substr(0, n) && o.substr(n + 1) === t.substr(t.length - o.length + n + 1) && r(o, e[i + o], o.split("/").length))
            )
                return;
        }
    ...
    function G(e) {
        ...
        return (
            -1 !== o
                ? ((t = e.substr(o + 1)), (r = e.substr(0, o)), "~" === t[0] && ((n = !0), (t = t.substr(1))))
                : ((n = "~" === e[0]), (t = "default"), (r = e.substr(n)), -1 !== Ve.indexOf(r) && ((t = r), (r = null))),
    ...
    function Q(e, t, r, n, o) {
        for (var i in t)
            "main" === i || "format" === i || "defaultExtension" === i || "configured" === i
                ? (n && void 0 !== e[i]) || (e[i] = t[i])
                : "map" === i
                ? (n ? E : k)((e.map = e.map || {}), t.map)
                : "meta" === i
                ? (n ? E : k)((e.meta = e.meta || {}), t.meta)
                : Object.hasOwnProperty.call(t, i) && x.call(o, '"' + i + '" is not a valid package configuration option in package ' + r);
        return (
            void 0 === e.defaultExtension && (e.defaultExtension = "js"),
            void 0 === e.main && e.map && e.map["."]
                ? ((e.main = e.map["."]), delete e.map["."])
                : "object" == typeof e.main && ((e.map = e.map || {}), (e.map["./@main"] = e.main), (e.main.default = e.main.default || "./"), (e.main = "@main")),
            e
        );
    }
    function V(e, t, r, n) {
    ...
    function re(e, t, r, n, o, i, a) {
        if (t) {
            ...
            try {
                ee(e),
                    !ot && e._nodeRequire && ((ot = e._nodeRequire("vm")), (it = ot.runInThisContext("typeof System !== 'undefined' && System") === e)),
                    it ? ot.runInThisContext(V(t, r, n, !a), {filename: n + (r ? "!transpiled" : "")}) : (0, eval)(V(t, r, n, !a)),
                    te();
            } catch (e) {
                return te(), e;
            }
    ...
    function de(e, t, r, n, o) {
        return Promise.resolve(r)
                            ...
                            for (var n = r[0].match(Dt), o = 0; o < n.length; o++) {
                                ...
                                if ((";" == i.substr(a - 1, 1) && a--, '"' == s || "'" == s)) {
                                    ...
                                    if (l) {
                                        ...
                                        "deps" === l && (l = "deps[]"),
                                            "[]" === l.substr(l.length - 2, 2) ? ((l = l.substr(0, l.length - 2)), (t.load[l] = t.load[l] || []), t.load[l].push(c)) : "use" !== l && he(t.load, l, c);
                                    } else t.load[u] = !0;
                                }
                            }
                    })(t, n),
            ...
            .then(function (r) {
                return n.load.format || '"bundle"' !== r.substring(0, 8)
                    ? "register" === n.load.format || (!n.load.format && fe(r))
                        ? ((n.load.format = "register"), r)
                        : "esm" === n.load.format || (!n.load.format && r.match(Rt))
                        ? ((n.load.format = "esm"), ge(e, r, t, n, o))
                        : r
    ...
    function me() {
        d.call(this),
            ...
            (this.scriptSrc = _t),
            (this._nodeRequire = ht),
            this.registry.set("@empty", Te),
            ve.call(this, !1, !1),
            dt(this);
    }
    function ve(e, t) {
    ...
    var ct,
        dt = function (e) {
            ...
            e.set("@@cjs-helpers", e.newModule({requireResolve: oe.bind(e), getPathVars: ie})),
                e.set("@@global-helpers", e.newModule({prepareGlobal: ue})),
                (r.amd = {}),
                (e.amdDefine = r),
                (e.amdRequire = t);
        };
    ...
    (me.prototype = Object.create(d.prototype)),
                        ...
                        return a
                            ? ((n.pluginKey = a.plugin),
                              Promise.all([D.call(i, r, a.argument, (o && o.pluginArgument) || t, n, o, !0), i.resolve(a.plugin, t)]).then(function (e) {
                                  if (((n.pluginArgument = e[0]), (n.pluginKey = e[1]), n.pluginArgument === n.pluginKey))
                                      throw new Error(
                                          "Plugin " + n.pluginArgument + " cannot load itself, make sure it is excluded from any wildcard meta configuration via a custom loader: false rule."
                                      );
            ...
            me.prototype.resolveSync =
                function e(t, r) {
                    var n = this[ze],
                        ...
                        a = F(n.pluginFirst, t);
                    return a
                        ? ((o.pluginKey = e.call(this, a.plugin, r)), q(n.pluginFirst, I.call(this, n, a.argument, i.pluginArgument || r, o, i, !!o.pluginKey), o.pluginKey))
                        : I.call(this, n, t, i.pluginArgument || r, o, i, !!o.pluginKey);
                }),
            ...
            return (
                ...
                .then(function () {
                    if (!t()) {
                        ...
                        return (
                            o.load.scriptLoad
                                ? (!o.load.pluginKey && jt) || ((o.load.scriptLoad = !1), x.call(n, 'scriptLoad not supported for "' + e + '"'))
                                : !1 !== o.load.scriptLoad &&
                                  !o.load.pluginKey &&
                                  jt &&
                                  (o.load.deps ||
                                      o.load.globals ||
                                      !("system" === o.load.format || "register" === o.load.format || ("global" === o.load.format && o.load.exports)) ||
                                      (o.load.scriptLoad = !0)),
                            o.load.scriptLoad
                                ? new Promise(function (n, i) {
                                      if ("amd" === o.load.format && Ee.define !== r.amdDefine)
                                          throw new Error("Loading AMD with scriptLoad requires setting the global `" + Mt + ".define = SystemJS.amdDefine`");
                                      j(
                                          e,
                                          o.load.crossOrigin,
                                          o.load.integrity,
        ...
        (me.prototype.config = function (e, t) {
            var r,
                ...
                i = this[ze];
            if (
                ("warnings" in e && (i.warnings = e.warnings),
                "wasm" in e && (i.wasm = "undefined" != typeof WebAssembly && e.wasm),
                ("production" in e || "build" in e) && ve.call(o, !!e.production, !!(e.build || (Pt && Pt.build))),
                !t)
            )
            ...
            if (
                (e.defaultJSExtensions && x.call(i, "The defaultJSExtensions configuration option is deprecated.\n  Use packages defaultExtension instead.", !0),
                "boolean" == typeof e.pluginFirst && (i.pluginFirst = e.pluginFirst),
                e.map)
            )
                for (var a in e.map) {
                    var s = e.map[a];
    ...
    for (
        var Ut = ["baseURL", "map", "paths", "packages", "packageConfigPaths", "depCache", "meta", "bundles", "transpiler", "warnings", "pluginFirst", "production", "wasm"],
            Tt = "undefined" != typeof Proxy,
            zt = 0;
        zt < Ut.length;
        zt++
    )
